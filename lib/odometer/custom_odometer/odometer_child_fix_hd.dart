...
class GameOdometerChildStyleFixedHD extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildStyleFixedHD({
    super.key,
  ...
  @override
  _GameOdometerChildStyleFixedHDState createState() => _GameOdometerChildStyleFixedHDState();
}

class _GameOdometerChildStyleFixedHDState extends State<GameOdometerChildStyleFixedHD> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildStyleFixedHD oldWidget) {
    ...
    return ClipRect(
      child: RepaintBoundary(
        child: Container(
          ...
          height:widget.isSmall==true? ConfigCustomText.odo_height_small :  ConfigCustomText.odo_height_hd_horizontal,
          child: Stack(
            children: [
              Positioned(
                top: -ConfigCustomText.odo_position_top_hd_horizontal,
                left: 0,
                right: 0,
                  ...
                  builder: (context, value, child) {
                    return RepaintBoundary(
                      child: SlideOdometerTransition(
                        verticalOffset:widget.isSmall==true?ConfigCustomText.text_odo_letter_vertical_offset_small :  ConfigCustomText.text_odo_letter_vertical_offset_hd_horizontal,
                        ...
                        letterWidth:widget.isSmall==true?ConfigCustomText.text_odo_letter_width_small : ConfigCustomText.text_odo_letter_width_hd_horizontal,
